          ...
          <div className="bg-slate-50 p-4 rounded-lg border border-slate-200 space-y-3">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input type="number" required value={form.unit_price} onChange={e => setForm({...form, unit_price: Number(e.target.value)})} className="mt-1 block w-full rounded-md border-0 py-1.5 text-slate-900 shadow-sm ring-1 ring-inset ring-slate-300 focus:ring-2 focus:ring-brand-600 sm:text-sm" />
              </div>
            </div>
          </div>
          <div className="bg-slate-50 p-4 rounded-lg border border-slate-200 space-y-3">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input type="number" min="0" value={form.discount} onChange={e => setForm({...form, discount: Number(e.target.value)})} className="mt-1 block w-full rounded-md border-0 py-1.5 text-slate-900 shadow-sm ring-1 ring-inset ring-slate-300 focus:ring-2 focus:ring-brand-600 sm:text-sm" />
              </div>
              <div>
                <label className="block text-sm font-medium text-slate-900">Ongkos Kirim (Rp)</label>
                <input type="number" min="0" value={form.shipping_cost} onChange={e => setForm({...form, shipping_cost: Number(e.target.value)})} className="mt-1 block w-full rounded-md border-0 py-1.5 text-slate-900 shadow-sm ring-1 ring-inset ring-slate-300 focus:ring-2 focus:ring-brand-600 sm:text-sm" />
              </div>
            </div>
            ...
            <div>
              ...
              <input type="number" min="0" max={getTotal()} value={form.down_payment} onChange={e => setForm({...form, down_payment: Number(e.target.value)})} className="mt-1 block w-full rounded-md border-0 py-1.5 text-slate-900 shadow-sm ring-1 ring-inset ring-slate-300 focus:ring-2 focus:ring-brand-600 sm:text-sm" />
            </div>
          </div>
