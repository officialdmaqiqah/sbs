...
BEGIN
    ...
    INSERT INTO journal_entries (
        ...
        'Supplier Bill from Receipt: ' || v_receipt.receipt_number,
        'Posted', p_created_by, 'SupplierBill', v_bill_id, 'Supplier Bill Creation'
    ...
    INSERT INTO audit_logs (
        organization_id, created_by, action, entity_type, entity_id, new_value
    ) VALUES (
