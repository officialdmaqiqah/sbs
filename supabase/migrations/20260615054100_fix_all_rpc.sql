CREATE OR REPLACE FUNCTION public.pay_customer_invoice(p_organization_id uuid, p_transaction_id uuid, p_customer_invoice_id uuid, p_cash_bank_account_id uuid, p_payment_number character varying, p_payment_date date, p_amount numeric, p_reference character varying, p_notes text, p_created_by uuid)
 RETURNS jsonb
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
